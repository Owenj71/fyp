...
child_Add_From_HTML_Form($conn,$child_id,$child_fname,$child_sname,$skill_test,$fitness_test,$medical_issue,$medical_match,$hospital_preference,$team_name,$membership,$date_of_birth);
